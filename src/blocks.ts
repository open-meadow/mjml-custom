...
export default (editor: Editor, opts: RequiredPluginOptions) => {
  ...
  const getI18nLabel = (label: string) =>
    editor.I18n.t(`grapesjs-mjml.components.names.${label}`);
  ...
  addBlock("mj-carousel", {
    ...
    content: `<mj-carousel>
        <mj-image class="item" src="https://source.unsplash.com/random/200x141" alt="Example image" />
        <mj-image class="item" src="https://source.unsplash.com/random/200x146" alt="Example image" />
    </mj-carousel>`,
  });
};
